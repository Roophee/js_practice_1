let clickBurger = document.getElementsByClassName("burger");
let clickContent = document.getElementsByClassName("content");
let clickHeader = document.getElementsByClassName("header");
let clickfooter = document.getElementsByClassName("footer");

let deBar = document.getElementsByClassName("aside");

clickBurger[0].addEventListener('click', hideSideBar);

clickContent[0].addEventListener('click', hideSideBarClickAway);
clickHeader[0].addEventListener('click', hideSideBarClickAway);
clickfooter[0].addEventListener('click', hideSideBarClickAway);

// MOVE ASIDE & CONTENT

function hideSideBar(e) {
    e.preventDefault();
    deBar[0].classList.toggle('hide__sidebar');
    clickContent[0].classList.toggle('move_content');
    clickBurger[0].classList.toggle('burger__stop');
    console.log(e.type)
...
clickBurger[0].addEventListener('keydown', function (e) {
    e.preventDefault();
    if (e.keyCode == "13") {
        deBar[0].classList.toggle('hide__sidebar');
        clickContent[0].classList.toggle('move_content');
...
function hideSideBarClickAway(e) {
    e.preventDefault();
    for (let i = 0; i < deBar[0].classList.length; i++) {
        if (deBar[0].classList[i] === 'hide__sidebar') {
            deBar[0].classList.toggle('hide__sidebar');
            clickBurger[0].classList.toggle('burger__stop');
            clickContent[0].classList.toggle('move_content');
        };
...
<div class="content__body">
    <img src="${contentRaw.imgurl}" alt="" class="content__img">
    <p>
    ...
    clickContent[0].innerHTML = makeContent;
};
